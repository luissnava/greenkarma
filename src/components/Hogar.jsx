    ...
    return (
        <div className="w-full">
            <div className="flex relative"> 
                ...
                <div className="bg-[#54c3eb] relative z-0 w-full h-[50vh] md:h-[90vh] sm:h-[60vh] h-[60vh]">

                </div>
                <div className="absolute text-gray-800 left-0 md:right-[10%] text-xl top-[50%] md:left-[10%] md:text-white sm:text-black z-10 ">
                    Mantén tu hogar siempre brillante y reluciente
                </div>
                <div className="absolute left-[10%] top-[60%] border border-white-400 text-white 
                flex justify-center p-3 hover:bg-black transition duration-100 mt-10">
